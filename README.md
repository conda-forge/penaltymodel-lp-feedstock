...
Once the `conda-forge` channel has been enabled, `penaltymodel-lp` can be installed with:

```
conda install penaltymodel-lp
```

It is possible to list all of the versions of `penaltymodel-lp` available on your platform with:
